...
import { Grid, AlignJustify, Rows, Columns } from "lucide-react";
      ...
      >
        ...
        <AccordionItem value="Dimensions" className="px-6 py-0 border-b-0">
          ...
          <AccordionContent>
            ...
            <div className="p-4 border rounded-lg shadow-md w-72 space-y-4">
            ...
            <div>
              ...
              <ToggleGroup
                type="single"
                value={editor.editor.selectedElement.styles.display || "flex"}
                onValueChange={(value) =>
                  dispatch({
                    type: "UPDATE_ELEMENT",
                    payload: {
            ...
            {/* Column Control */}
            {editor.editor.selectedElement.styles.display === "grid" && (
              <div>
                <p className="text-sm font-medium mb-2">Columns</p>
                <Slider
                  defaultValue={[
                    //@ts-ignore
                    parseInt(editor.editor.selectedElement.styles.gridTemplateColumns?.match(/\d+/)?.[0]) || 3,
                  ]}
                  min={1}
                  max={6}
                  step={1}
                ...
                <p className="text-xs text-gray-500 mt-1">
                  ...
                  {editor.editor.selectedElement.styles.gridTemplateColumns?.match(/\d+/)?.[0] || 3} Columns
                </p>
              </div>
            )}
            ...
            <div>
              <p className="text-sm font-medium mb-2">Padding Bottom</p>
              <input
                id="paddingBottom"
                type="number"
                ...
                //@ts-ignore
                value={parseInt(editor?.editor?.selectedElement?.styles?.paddingBottom!) || 0}
              />
            </div>
            ...
            <div
              ...
              style={{
                display: editor.editor.selectedElement.styles.display || "grid",
                gridTemplateColumns:
                  editor.editor.selectedElement.styles.gridTemplateColumns || "repeat(3, 1fr)",
              }}
            >
              {[...Array(6)].map((_, index) => (
                <div
                  key={index}
                  className="h-10 border border-dashed border-gray-400 flex items-center justify-center text-xs"
                >
                  {index + 1}
                </div>
              ))}
            ...
            <div>
              ...
              <ToggleGroup
                type="single"
                value={editor.editor.selectedElement.styles.justifyContent || "start"}
                onValueChange={(value) =>
                  dispatch({
                    type: "UPDATE_ELEMENT",
                    payload: {
