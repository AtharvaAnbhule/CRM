      ...
      {PRICING.map((price, idx) => (
        ...
        >
          <AnimatePresence>
            {hoveredIndex === idx && (
              <motion.span
                className="absolute inset-0 h-full w-full bg-gradient-to-br from-[#6B46C1] to-[#9F7AEA] opacity-20 rounded-3xl"
          ...
          <Card
            key={price.title}
            className={cn(
              "w-[300px] flex flex-col justify-between z-30 relative overflow-hidden border border-gray-300 dark:border-gray-700 rounded-3xl bg-white dark:bg-gray-900 shadow-md",
              {
                "border border-primary bg-gradient-to-br from-[#6B46C1] to-[#9F7AEA] text-white":
