  ...
  return (
    <>
      ...
      <header className="sticky top-0 left-0 right-0 z-20  shadow-md backdrop-blur-md px-6 py-3">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <Image
              src={require("../../../../public/assets/fire.png")}
              width={60}
              height={60}
              alt="WorkelooLogo"
            />
          ...
          <div className="flex gap-2">
            <Link
              className="rounded-full w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-500 hover:opacity-80 transition justify-center align-middle m-auto"
              href="/Extra">
              <FileText
      ...
      <aside className="fixed right-0 top-1/2 transform -translate-y-1/2 flex flex-col gap-10 z-30">
        ...
        <Link
          href="/About"
          className="relative z-[9999] px-4 py-2 bg-[#6B46C1] text-white text-sm font-medium rounded-sm shadow-md hover:bg-teal-700 transition-all">
          About
        </Link>
