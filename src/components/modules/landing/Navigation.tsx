...
const Navigation = async () => {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 left-0 right-0 z-20  shadow-md backdrop-blur-md px-6 py-3">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <Image src={logoImage} width={36} height={36} alt="Workeloo Logo" />
            <span className="text-2xl font-bold text-gray-900">Workeloo</span>
          </Link> 
          ...
          <Link className = "rounded-full w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-500 hover:opacity-80 transition justify-center align-middle m-auto" href="/Extra">
                  <FileText aria-label="Notifications" className = "w-8 h-8 text-white" />
                    ...
                    <Link className = "rounded-full w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-500 hover:opacity-80 transition justify-center align-middle m-auto" href="/CodeBuilder">
                  <Code2Icon aria-label="Notifications" className = "w-8 h-8 text-white" />
                    </Link> 
      ...
      <Link
          href="/company"
          className="px-4 py-2 bg-[#6B46C1] text-white text-sm font-medium rounded-sm shadow-md hover:bg-teal-700 transition-all"
        >
          Dashboard
        </Link> 
        <Link
