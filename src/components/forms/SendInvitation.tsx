...
const SendInvitation: React.FC<SendInvitationProps> = ({ agencyId }) => {
  ...
  return (
    ...
    <CardTitle>Invitation for a member </CardTitle>
      <CardDescription>
          An invitation will be sent to the user.an invitation can be sent to an particular e - mail id once only. 
        </CardDescription>
    </CardHeader>
    < CardContent >
    <Form { ...form } >
        ...
        <h2 className="text-xl font-semibold" > Sent Requests </h2>
          < div className = "relative" >
            <Search className="w-4 h-4 absolute left-4 top-3 text-gray-400" />
              <Input placeholder="Search name..." className = "pl-10 bg-gray-800 text-white" />
                </div>
                </div>
