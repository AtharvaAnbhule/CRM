...
export default function LeadsPage() {
  ...
  const fetchAllLeads = async () => {
    ...
    setFetching(true);
    try {
      const response = await fetch(`/api/accounts/${subaccountId}/lead`);
  ...
  const fetchLeadNotes = async (leadId: string) => {
    ...
    try {
      const response = await fetch(
        `/api/accounts/${subaccountId}/lead/${leadId}/notes`
      );
  ...
  const saveLeads = async () => {
    ...
    try {
      const response = await fetch(
        `/api/accounts/${subaccountId}/lead/upload`,
        {
          method: "POST",
          headers: {
  ...
  const updateLeadStatus = async (id: string, status: Lead["status"]) => {
    try {
      const response = await fetch(`/api/accounts/${subaccountId}/lead/${id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const addNoteToLead = async () => {
    ...
    try {
      const response = await fetch(
        `/api/accounts/${subaccountId}/lead/${selectedLead.id}/notes`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const updateNote = async () => {
    ...
    try {
      const response = await fetch(
        `/api/accounts/${subaccountId}/lead/${selectedLead.id}/notes/${editingNote.id}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
  ...
  const deleteNote = async (noteId: string) => {
    try {
      ...
      const response = await fetch(
        `/api/accounts/${subaccountId}/lead/${selectedLead.id}/notes/${noteId}`,
        {
          method: "DELETE",
        }
      );
