    ...
    <div
      ...
      <div
        className={clsx(
          ...
          bgEnabled &&
            "bg-gradient-to-br from-pink-500 via-red-500 to-orange-400 mt-6"
        )}
        ...
        <div
          ...
          <div className="flex space-x-2 mb-3 items-center">
            ...
            <span className="ml-auto text-xs sm:text-sm text-gray-400 pr-2 truncate">
              Enter your Environment keys
            </span>
          </div>
